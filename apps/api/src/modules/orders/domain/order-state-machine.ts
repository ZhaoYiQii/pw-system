...
export const ORDER_TRANSITIONS: Record<OrderStatusType, readonly OrderStatusType[]> = {
...
export function assertOrderTransition(orderId: string, from: OrderStatusType, to: OrderStatusType): void {
