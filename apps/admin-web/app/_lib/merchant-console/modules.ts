...
export const MERCHANT_FUTURE_MODULES: readonly MerchantNavItem[] = [
  { id: "order-rush-hall", domain: "orders", label: "抢单大厅", description: "集中查看可抢订单和响应进度。", status: "preview" },
  { id: "order-reviews", domain: "orders", label: "评价管理", description: "查看服务评价并跟进低分反馈。", status: "preview" },
  { id: "people-schedule", domain: "people", label: "排班管理", description: "配置陪玩可接单时段和班次。", status: "preview" },
  { id: "people-tags", domain: "people", label: "标签分组", description: "用标签与分组管理客户和陪玩。", status: "preview" },
  { id: "people-relations", domain: "people", label: "关系管理", description: "查看屏蔽、关系流水和配对异常。", status: "planned" },
  { id: "people-staff", domain: "people", label: "员工管理", description: "管理客服、财务和店长账号。", status: "planned" },
  { id: "catalog-pricing", domain: "catalog", label: "价格方案", description: "管理服务售价和时长规则。", status: "preview" },
  { id: "catalog-sharing", domain: "catalog", label: "分成方案", description: "配置门店与陪玩分成规则。", status: "preview" },
  { id: "catalog-addons", domain: "catalog", label: "附加服务", description: "配置可选增值服务。", status: "planned" },
  { id: "catalog-limits", domain: "catalog", label: "限购方案", description: "按商品、客户和时段配置限制。", status: "planned" },
  { id: "catalog-certificates", domain: "catalog", label: "技能证书", description: "管理技能证明和审核要求。", status: "planned" },
  { id: "catalog-decoration", domain: "catalog", label: "店铺装修", description: "配置对客页面的品牌内容。", status: "planned" },
  { id: "marketing-discounts", domain: "marketing", label: "优惠活动", description: "统一管理优惠券、折扣和领取记录。", status: "preview" },
  { id: "marketing-invitations", domain: "marketing", label: "邀请奖励", description: "配置邀请方案、奖励和渠道统计。", status: "preview" },
  { id: "marketing-growth", domain: "marketing", label: "会员成长", description: "配置等级、成长值与升级规则。", status: "planned" },
  { id: "marketing-benefits", domain: "marketing", label: "权益礼包", description: "管理等级权益和礼包记录。", status: "planned" },
  { id: "marketing-backpack", domain: "marketing", label: "用户背包", description: "集中展示用户持有的权益与道具。", status: "planned" },
  { id: "marketing-games", domain: "marketing", label: "互动玩法", description: "管理店内互动模板和玩法。", status: "planned" },
  { id: "finance-ledger", domain: "finance", label: "资金账单", description: "查询账户流水和资金去向。", status: "preview" },
  { id: "finance-payments", domain: "finance", label: "支付退款", description: "汇总支付记录、退款与处理状态。", status: "preview" },
  { id: "finance-withdrawals", domain: "finance", label: "提现管理", description: "管理陪玩提现申请与渠道。", status: "planned" },
  { id: "finance-reconcile", domain: "finance", label: "财务对账", description: "核对平台、门店与外部渠道流水。", status: "planned" },
  { id: "finance-arrears", domain: "finance", label: "欠款追踪", description: "跟进待补款与异常账款。", status: "planned" },
  { id: "insights-summary", domain: "insights", label: "综合分析", description: "汇总订单、收入和履约指标。", status: "preview" },
  { id: "insights-trends", domain: "insights", label: "经营趋势", description: "按时间观察订单与收入变化。", status: "preview" },
  { id: "insights-ranking", domain: "insights", label: "业绩排行", description: "查看陪玩和员工的服务表现。", status: "preview" },
  { id: "insights-care", domain: "insights", label: "客户关怀", description: "识别需要回访的客户。", status: "planned" },
  { id: "insights-churn", domain: "insights", label: "流失预警", description: "识别活跃度下降的客户与陪玩。", status: "planned" },
  { id: "insights-private-order", domain: "insights", label: "私单风险", description: "提供需人工核查的异常线索。", status: "planned" },
  { id: "settings-permissions", domain: "settings", label: "员工权限", description: "查看角色与模块访问范围。", status: "preview" },
  { id: "settings-notifications", domain: "settings", label: "通知规则", description: "配置站内提醒和触达策略。", status: "preview" },
  { id: "settings-miniprogram", domain: "settings", label: "小程序管理", description: "管理独立小程序绑定与状态。", status: "planned" },
  { id: "settings-channels", domain: "settings", label: "渠道管理", description: "管理邀请和合作渠道。", status: "planned" },
  { id: "settings-help", domain: "settings", label: "帮助中心", description: "查看操作说明与常见问题。", status: "planned" },
] as const;
