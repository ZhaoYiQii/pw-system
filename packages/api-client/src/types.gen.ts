...
export type GameDispatchSummaryData = {
    body?: never;
    path?: never;
    query?: never;
    url: '/api/v1/tenant/game-dispatch/summary';
};

export type GameDispatchSummaryResponses = {
    200: {
        /**
         * 订单中心页头汇总
         */
...
export type GameDispatchSummaryResponse = GameDispatchSummaryResponses[keyof GameDispatchSummaryResponses];
